...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      // Rutas pendientes (de tu compañera)
      { path: 'entradas', loadComponent: () => import('./features/entradas/entrada-list').then(m => m.EntradaListComponent) },
      { path: 'sedes', loadComponent: () => import('./features/sedes/sede-list').then(m => m.SedeListComponent) },
      { path: 'atracciones', loadComponent: () => import('./features/atracciones/atraccion-list').then(m => m.AtraccionListComponent) },
      { path: 'acuaticas', loadComponent: () => import('./features/acuaticas/acuatica-list').then(m => m.AcuaticaListComponent) },
    ]
  },
